...
namespace The_GST_1.Controllers
{
    ...
    public class EmailSendingController : Controller
    {
        ...
        public EmailSendingController(UserManager<IdentityUser> userManager, IEmailSender sender, IExtraDetails extra, IEmailActivity emailActivity,IFellowshipRepository fellowship, IWebHostEnvironment webHostEnvironment, IErrorLogs errorLogs)
        {
        ...
        public async Task<IActionResult> Email_ReConfirmation_link()
        {
            ...
            catch (Exception ex)
            {
                ...
                var errorMessage = "AN ERROR OCCURRED WHILE SENDING EMAIL CONFIRMATION LINK.";
